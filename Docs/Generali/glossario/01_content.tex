...
\section{P}
    ...
    \label{PB}
    (s. p. f.)\\
    Acronimo di "Product Baseline", indica la seconda e ultima revisione di avanzamento del progetto effettuata dai docenti (committenti) durante la quale si verificano gli obiettivi funzionali e qualitativi del prodotto. La revisione si articola in due parti: al termine della prima, il prodotto viene presentato al proponente per l'accetazione come Minimum Viable Product (MVP).
    \subsection{PoC}
    (s. p. m.)\\
