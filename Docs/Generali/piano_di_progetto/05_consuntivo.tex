...
\subsubsubsection{Resoconto}
Le ore totali di lavoro preventivate per ogni singolo ruolo aderiscono perfettamente con le ore effettivamente impiegate per il compimento di tutte 
le attività programmate per questo sprint.\\
Il sistema di preventivazione delle ore per questo sprint è risultato nel complesso accurato e ben stimato.
