...
I processi di supporto contribuiscono a rendere i processi primari più efficienti ed efficaci.
    \subsection{Documentazione}
        ...
        \begin{itemize}
            \item \textbf{Grassetto}: utilizzato per i titoli delle sezioni, per i sottotitoli e per i paragrafi, parole tecniche o termini specifici che necessitano di evidenza nel contesto;
            ...
            \begin{itemize}
                ...
                \item \textbf{Qualità di processo}: viene indicato lo standard adottato per la valutazione dei processi e quello per garantire un miglioramento continuo.\\
                                                    ...
                                                    \begin{itemize}
                                                        ...
                                                        \item \textbf{Processi di supporto}: riporta una descrizione dei processi di documentazione, accertamento della qualità e verifica, e specifica le metriche; 
    ...
    \subsection{Verifica\textsubscript{g}}
        ...
        \begin{itemize}
            \item \textbf{Analisi statica}: non richiede esecuzione dell'oggetto di verifica, quindi applicabile a documentazione e codice, usata per accertare conformità e regole nonchè assenza di difetti, adotteremo i due seguenti metodi di lettura:
             \begin{itemize}
