...
di supporto e la gestione del personale.
    ...
    \subsection{Gestione di Infrastrutture}
        ...
        La project board è divisa in 4 pannelli dove ogni uno raggruppa e mostra le issue in base alle proprie caratteristiche.
        \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf{Waiting for review}: issue terminate e che potrebbero essere chiuse definitivamente dopo la verifica della modifiche apportate al documento;
