...
\begin{itemize}
    ...
    \item \textbf{Valore accettabile}: $\geq$ BAC - 5\% \\ $\leq$  BAC + 5\%
...
\MPC{Estimated to Complete (ETC)}{ETC}
...
Percentuale che indica i rami di decisione nel codice del che sono stati eseguiti tramite test.
\begin{itemize}
...
\MPD{Requisiti desiderabili soddisfatti}{OR}
...
\MPD{Tempo di apprendimento (EOL)}{EOL}
...
\MPD{Complessità ciclomatica (CYC)}{CYC}
